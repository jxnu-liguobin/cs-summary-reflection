...
public class T66 {
    ...
    public int countingStep(int limit, int rows, int cols, int r, int c, boolean[][] visited) {
        ...
        visited[r][c] = true;
        return countingStep(limit, rows, cols, r - 1, c, visited) + countingStep(limit, rows, cols, r, c - 1, visited)
                + countingStep(limit, rows, cols, r + 1, c, visited) + countingStep(limit, rows, cols, r, c + 1, visited) + 1;
    }
