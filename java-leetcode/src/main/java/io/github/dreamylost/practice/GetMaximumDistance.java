...
public class GetMaximumDistance {
    ...
    public static void main(String[] args) {
        ...
        node2.left = node5;
        System.out.println("tree:" + PringTreeFromTopToBottom.PrintFromTopToBottom(root));
    ...
    public static RESULT getMaximumDistance(TreeNode root) {
        ...
        result.maxDistance =
                Math.max(
                        Math.max(lhs.maxDistance, rhs.maxDistance),
                        lhs.maxDepth + rhs.maxDepth + 2);
        return result;
    }
}
