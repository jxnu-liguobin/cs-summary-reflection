 ...
 *
 * <p>696. Count Binary Substrings (Easy)
 *
 * <p>Input: "00110011" Output: 6 Explanation: There are 6 substrings that have equal number of
...
public class Leetcode_696_String {
    ...
    /**
     * 逻辑：每当我们在‘0’字符或‘1’字符之间切换时，我们都知道这是需要更新总数的时候。 如果我们有如下顺序.。000011111111000(4个零，9个1，3个零)总数是4+3。
     ...
     * 所以我们可以把字符串相邻的0,1个数统计出来 ，实例一可统计为： 2 2 2 ；相邻取比较小的那个值相加 为 2+2+2 = 6 再来一个例子 000110000111 ：
     * 统计每块儿的个数： 3 2 4 3 ；相邻较小数字相加：2+2+3 = 7
