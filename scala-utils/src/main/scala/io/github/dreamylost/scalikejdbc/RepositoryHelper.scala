...
object RepositoryHelper {
  ...
  object TypeBinders {
    ...
    implicit val targetFieldsTypeBinder: TypeBinder[Map[String, String]] = new TypeBinder[Map[String, String]] {
      ...
      def apply(rs: ResultSet, columnIndex: Int): Map[String, String] =
        JacksonScalaSupport.mapper.readValue(rs.getString(columnIndex), classOf[Map[String, String]])
    }
  }
